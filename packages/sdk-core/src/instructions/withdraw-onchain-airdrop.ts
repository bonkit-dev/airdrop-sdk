...
export type WithdrawOnchainAirdropAutoAccounts = {
  creator: PublicKey
  airdrop: PublicKey
  mint: PublicKey
...
export type WithdrawOnchainAirdropArgs = {
  accounts: WithdrawOnchainAirdropAutoAccounts
  options?: AutoInstructionOptions
}

export const withdrawOnchainAirdropInstruction = async (
  { accounts, options }: WithdrawOnchainAirdropArgs,
