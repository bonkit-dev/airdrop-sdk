...
export type CancelMerkleAirdropAutoAccounts = {
  creator: PublicKey
  airdrop: PublicKey
  mint: PublicKey
...
export type CancelMerkleAirdropArgs = {
  accounts: CancelMerkleAirdropAutoAccounts
  options?: AutoInstructionOptions
}

export const cancelMerkleAirdropInstruction = async (
  { accounts, options }: CancelMerkleAirdropArgs,
